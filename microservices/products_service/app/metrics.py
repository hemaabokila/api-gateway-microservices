...
REQUEST_COUNT = Counter(
    'products_service_http_requests_total',
    'Total HTTP Requests for Products Service',
    ['method', 'endpoint', 'status_code']
)

REQUEST_LATENCY = Histogram(
    'products_service_http_request_duration_seconds',
    'HTTP Request Latency for Products Service',
    ['method', 'endpoint', 'status_code']
)

IN_PROGRESS_REQUESTS = Gauge(
    'products_service_http_requests_in_progress',
    'Number of in-progress HTTP requests for Products Service',
    ['method', 'endpoint']
)
