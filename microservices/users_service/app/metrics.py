...
REQUEST_COUNT = Counter(
    'users_service_http_requests_total',
    'Total HTTP Requests for Users Service',
    ['method', 'endpoint', 'status_code']
)

REQUEST_LATENCY = Histogram(
    'users_service_http_request_duration_seconds',
    'HTTP Request Latency for Users Service',
    ['method', 'endpoint', 'status_code']
)

IN_PROGRESS_REQUESTS = Gauge(
    'users_service_http_requests_in_progress',
    'Number of in-progress HTTP requests for Users Service',
    ['method', 'endpoint']
)
